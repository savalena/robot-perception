...
class Main(object):
    ...
    def save_data(self):
        ...
        np.save("/home/ubuntu/catkin_ws/src/robot-perception/src/position.npy'", self.delta_position_array)
        np.save("/home/ubuntu/catkin_ws/src/robot-perception/src/time.npy'", self.time_array)
        np.save("/home/ubuntu/catkin_ws/src/robot-perception/src/ranges.npy'", self.ranges_array)
        np.save("/home/ubuntu/catkin_ws/src/robot-perception/src/angles.npy'", self.angles_array)
